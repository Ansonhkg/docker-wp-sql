...
if(class_exists( 'woocommerce' )){
	...
	if(amory_data("woocommerc_shop_display") != 0 ) {
		add_filter( 'loop_shop_per_page', create_function( '$cols', 'return '.amory_data("woocommerc_shop_display").';' ), 20 );
	}

	if(amory_data("woocommerc_shop_display_row") != 0) {
		add_filter( 'loop_shop_columns', create_function(  '$columns','return '.amory_data("woocommerc_shop_display_row").';' ) );
	}
...
add_action( 'tgmpa_register', 'dreamscape_required_plugins' );

function dreamscape_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => esc_attr__('Revolution Slider','amory'), // The plugin name.
            'slug'               => 'revslider', // The plugin slug (typically the folder name).
            'source'             => 'http://amory.premiumcoding.com/democontent/wp-content/uploads/2017/03/revslider.zip', // The plugin source.
		...
		array(
				'name'      => esc_attr__('Facebook Page Like Widget','amory'),
